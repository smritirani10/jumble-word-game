...
public class JumbleWord extends AppCompatActivity {
    TextView tv_info,tv_word;
    EditText et_guess;
    Button b_check,b_new;
    Random r;
    String currentWord;
    String[]dictionary={"python","java","c++","javascript","android","corejava","ruby","c#","html","css"};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_jumble_word);
